...
INSERT INTO `kinodev_local`.`Halls` (`Id`, `Name`) VALUES ('3', 'Sala C');
INSERT INTO `kinodev_local`.`Halls` (`Id`, `Name`) VALUES ('4', 'Grand Hall');
INSERT INTO `kinodev_local`.`Halls` (`Id`, `Name`) VALUES ('5', 'Sala VIP');
...
BEGIN
    ...
    row_loop: WHILE @r <= 5 DO
		...
		number_loop: WHILE @n <= 6 DO
				-- HALL VIP 4 x 6
				INSERT INTO `kinodev_local`.`Seats` (`HallId`, `Row`, `Number`) VALUES ('5', @r, @n);
			set @n = @n + 1;
		END WHILE number_loop;
       set @r = @r + 1;       
    END WHILE row_loop; 
